...
| V4-08 | Generic worker boundary | DESIGN_COMPLETE / EXTERNAL_REVIEW_PENDING (WorkerPortV1 dispatch+wait sealed; registry facade public surface sealed; wait resolution failure throws into broker boundary; registration snapshot semantics sealed; persisted Registry remains Antigravity-only; WREG corrected matrix defined) |
