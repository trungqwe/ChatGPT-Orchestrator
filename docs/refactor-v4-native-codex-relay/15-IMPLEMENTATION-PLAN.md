...
| V4-08 | Generic worker boundary | DESIGN_COMPLETE / EXTERNAL_REVIEW_PENDING (WorkerPortV1 sealed as dispatch+wait; exact engine adapter registry defined; persisted Registry remains Antigravity-only; no fallback/dynamic engine loading; Antigravity regression and WREG implementation matrix defined) |
