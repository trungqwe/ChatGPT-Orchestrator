...
| V4-09 | One-shot full cycle | IN_PROGRESS (WP-V4-09A APPROVED_CLOSED; WP-V4-09B APPROVED_CLOSED; WP-V4-09C real P1 exposed worker delivery-provenance gap: AO exit 0 occurred but authoritative transcript contained no dispatch boundary; P1 remains blocked; delivery acknowledgement design correction pending implementation; no real retry authorized) |
