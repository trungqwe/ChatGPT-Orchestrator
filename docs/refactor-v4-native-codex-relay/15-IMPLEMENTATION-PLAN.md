...
| V4-07 | Audit/recover CLI | IMPLEMENTATION_COMPLETE / EXTERNAL_REVIEW_PENDING (Audit/recover CLI implemented; 4 explicit commands: inspect, recover, resolve-uncertainty, retire-legacy; strict output projection; source-exact lifecycle delegation; 58 ARC tests pass; 16 deterministic suites pass; no real model turn; external review pending) |
