...
- [x] Model resolver & token usage complete (WP-V4-06 COMPLETE: WO-V4-06A resolved policy authority and first-turn pinning complete; WO-V4-06B pure token usage observer, exact turn correlation, early race resolution, snapshot preservation, bounded storage complete; budget enforcement reserved for WP-V4-12).
